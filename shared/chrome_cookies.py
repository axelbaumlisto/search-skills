...
Why: a platform session is bound to the machine and IP that created it. Reusing
a server's cookies from a laptop (or vice versa) looks like session hijacking to
the risk scoring of Meta or Shopee. If you are logged in in the local Chrome,
...
Usage:
    ...
    chrome_cookies.py facebook.com --out ~/.config/search-skills/facebook.cookies.txt
